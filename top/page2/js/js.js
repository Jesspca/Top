...
let titulos =["Matrix","Blade","Interlestelar","Watchmen","Harry Potter"];
...
function agregarFila(){
  ...
  //let top= prompt('Cual es el top');
  //let pelicula=prompt(' Cual es la pelicula');
  //let cali= prompt('Cual e sla calificacion');
  //let imagne=prompt('Cual es la url de imagen');